...
.. image:: https://img.shields.io/github/license/guard-project/cb-manager
    :target: https://github.com/guard-project/cb-manager/-/blob/master/LICENSE
    :alt: MIT License

.. image:: https://img.shields.io/github/languages/code-size/guard-project/cb-manager?color=red&logo=github
    :target: https://github.com/guard-project/cb-manager
    :alt: GitHub Code Size

.. image:: https://img.shields.io/github/repo-size/guard-project/cb-manager?color=red&logo=github
    :target: https://github.com/guard-project/cb-manager
    :alt: GitHub Repository Size

.. image:: https://img.shields.io/github/v/tag/guard-project/cb-manager?label=release&logo=github
    :target: https://github.com/guard-project/cb-manager/releases
    :alt: GitJHub Release
...
.. image:: https://pyup.io/repos/github/guard-project/cb-manager/shield.svg
    :target: https://pyup.io/repos/github/guard-project/cb-manager/
    :alt: PyUP

.. image:: https://pyup.io/repos/github/guard-project/cb-manager/python-3-shield.svg
     :target: https://pyup.io/repos/github/guard-project/cb-manager/
     :alt: Python 3991

.. image:: https://travis-ci.org/guard-project/cp-manager.svg?branch=master
    :target: https://travis-ci.org/guard-project/cb-manager
    :alt: Travis CI
...
This part is out of scope of the |GUARD| project context and, for this reason, it is this highlighted with a dashed box.
...
|                +-----------------+--------------------+---------------------------------------------------------+
|                | password        | guard [9]_        | Password for |HTTP| authentication (for developer use). |
+----------------+-----------------+--------------------+---------------------------------------------------------+
...
.. |GUARD| replace:: :abbr:`GUARD (GUArantee Reliability and trust for Digital service chains)`
