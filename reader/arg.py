...
class ArgReader:
    ...
    def init(cls):
        ...
        add('--host', '-o', type=str, help='Hostname/IP of the REST Server',
            default=cls.cr.cb_host)
        add('--port', '-p', type=int, help='TCP Port of the REST Server',
        ...
        add('--apm-enabled', '-n',
            help='Enable Elastic APM integration', action='store_true')
    ...
    def read(cls):
        ...
        for field in ('hb_timeout', 'hb_period',
