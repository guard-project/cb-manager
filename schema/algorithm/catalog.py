...
PARAMETER_TYPES = ['binary', 'boolean', 'choice', 'integer', 'number',
...
class AlgorithmCatalogParameterSchema(Schema):
    ...
    description = Str(example='Enable the algorithm.',
...
class AlgorithmCatalogSchema(BaseSchema):
    ...
    encoding_scheme = Str(default='base64', example='base64',
                          description='Encoding scheme used to store the binary data')  # noqa: E501
