...
class NetworkLinkSchema(BaseSchema):
    ...
    description = Str(example='Allow communication between front-end and back-end services.',  # noqa: E501
...
class NetworkLinkTypeSchema(BaseSchema):
    ...
    description = Str(example='Communications connection between two communication endpoints.',  # noqa: E501
                      description='Short description of the network link type.')  # noqa: E501
